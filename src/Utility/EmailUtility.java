...
public class EmailUtility {
    public static void sendEmail(Properties smtpProperties, String toAddress, String subject, String messages, File[] attachFiles) throws AddressException, MessagingException, IOException
    {
        ...
        messBodyPart.setContent(messages, "text/html");
